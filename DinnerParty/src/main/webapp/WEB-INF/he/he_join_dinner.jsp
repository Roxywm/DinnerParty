...
<div class="memwrap wrap clearfix">
    <div class="section fl">
        <div class="location tr"><a href="${ctx}/he/heMain?userId=${user.id}" class="current" style="border-radius: 50%;">参加的饭局</a><a href="${ctx}/he/heHostDinner?userId=${user.id}">发布的饭局</a><a href="${ctx}/he/heMessage?userId=${user.id}">TA的评价</a><a href="${ctx}/he/heConcern?userId=${user.id}">TA的关注</a></div>
