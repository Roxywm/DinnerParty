...
<div class="memwrap wrap clearfix">
    <div class="section fl">
        <div class="location tr"><a href="${ctx}/me/home">首页</a><a href="${ctx}/me/meDinner">我的饭局</a><a href="${ctx}/me/follow">我的关注</a><a href="${ctx}/me/message" class="current" style="font-weight: bold">我的留言</a></div>
