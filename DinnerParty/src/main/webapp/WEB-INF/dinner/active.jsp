            ...
            <c:forEach items="${dinnerPage.list}" var="dinner">
                <li>
                    ...
                    <div class="active-info">
                        <div class="user">
                            <a href="#" class="userimg"><img src="${ctx}/userIcon/${dinner.user.icon}"></a>
                            <a href="#">${dinner.user.nickname}</a><em class="user-level"></em><em class="user-level"></em><em class="user-level"></em>
                        </div>
    ...
    <div class="aside fr">
        ...
        <div class="hot-active">
            ...
            <div class="active-info">
                <div class="user">
                    <a href="#" class="userimg"><img src="${ctx}/userIcon/${dinner.user.icon}"></a>
                    <a href="#">${dinner.user.nickname}</a>
                </div>
                <div class="hd"><a href="#">${dinner.titel}</a></div>
