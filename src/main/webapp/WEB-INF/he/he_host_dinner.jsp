        ...
        <div class="Participate pd30">
            ...
            <c:forEach items="${page.list}" var="dinner">
                <div class="item">
                    ...
                    <div class="hd"><span class="username">${dinner.user.nickname}</span>  报名了  <span class="Period">NO.${dinner.id}期活动</span></div>
                    <div class="bd">
                        <c:if test="${dinner.endTime.time < newDate.time}">
                            <span class="Expired indent">已过期</span>
                        </c:if>
                        <div class="Activity-img img"><a href="${ctx}/mutually/dinner/dinnerDetail?dinnerId=${dinner.id}"><img src="${ctx}/uploads/${dinner.thumbnail}"></a></div>
                        <div class="txt">
                            ...
                            <p class="Status-wrap mt5 clearfix"><span class="ff4800 fr">报名费：${dinner.price}元</span><a href="#" class="Status">评论</a>  <span class="Selected"><em class="myfont">&#xe64b;</em>已选中</span></p>
                        </div>
                    </div>
                </div>
            </c:forEach>
