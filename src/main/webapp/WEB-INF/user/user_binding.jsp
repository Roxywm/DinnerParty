...
<div class="memwrap wrap clearfix">
    <div class="section fl">
        <div class="location tr"><a href="${ctx}/user/edit">基本资料</a><a href="${ctx}/user/edit/pwd">修改密码</a><a href="${ctx}/user/edit/binding" class="current" style="font-weight: bold;">帐号绑定</a></div>
        <div class="pd20">
